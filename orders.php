...
// Fetch data from the BusinessDetailsView view with pagination
$sql = "SELECT * FROM BusinessDetailsView LIMIT $start_from, $results_per_page";
...
<body class="app">   	
  ...
  <path d="M5.255 5.786a.237.237 0 0 0 .241.247h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286zm1.557 5.763c0 .533.425.927 1.01.927.609 0 1.028-.394 1.028-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94z"/>
				    ...
				    <div class="col-auto">
					     <div class="page-utilities">
						    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
							    ...
							    <!-- HTML for the download button -->
								<div class="col-auto">
    <button class="btn app-btn-secondary" id="download-csv">
                    ...
                    <tbody>
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                echo "<tr>";
                                echo "<td class='cell'>" . $row['Business_name'] . "</td>";
                                echo "<td class='cell'>" . $row['email'] . "</td>";
                                echo "<td class='cell'>" . $row['contact'] . "</td>";
                                echo "<td class='cell'>" . $row['establishment_date'] . "</td>";
                                echo "<td class='cell'>" . $row['Business_type'] . "</td>";
                                echo "<td class='cell'>" . $row['longitude'] . "</td>";
                                echo "<td class='cell'>" . $row['latitude'] . "</td>";
                                echo "<td class='cell'>" . $row['town'] . "</td>";
                                echo "<td class='cell'>$" . $row['loan_amount'] . "</td>";
                                echo "<td class='cell'>$" . $row['Outstanding_Balance'] . "</td>";
                                echo "<td class='cell'>" . $row['Owner_Name'] . "</td>";
                                echo "</tr>";
                            }
                        } else {
    ...
    <?php
    // Pagination
    $sql = "SELECT COUNT(*) AS total FROM BusinessDetailsView";
    $result = mysqli_query($conn, $sql);
