...
<body class="app app-login p-0">    	
    ...
    <div class="password mb-3" style="position: relative;">
        ...
        <span class="toggle-password" onclick="togglePassword('signin-password')">
            <i class="far fa-eye" id="toggleSigninPassword"></i>
        </span>
    ...
    <div class="text-center">
        ...
        var toggleButton = document.getElementById('toggle' + passwordFieldId.charAt(0).toUpperCase() + passwordFieldId.slice(1) + 'Password');
